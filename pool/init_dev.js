...
if (cluster.isWorker){
    switch(process.env.workerType){
        case 'pool':
            require('./lib_dev/pool.js');
            break;
        case 'blockUnlocker':
            require('./lib_dev/blockUnlocker.js');
            break;
        case 'paymentProcessor':
            require('./lib_dev/paymentProcessor.js');
            break;
        case 'api':
            require('./lib_dev/api.js');
            break;
        case 'cli':
            require('./lib_dev/cli.js');
            break
    }
    return;
}
...
require('./lib_dev/exceptionWriter.js')(logSystem);


var singleModule = (function(){

    var validModules = ['pool', 'api', 'unlocker', 'payments',  'cli'];
